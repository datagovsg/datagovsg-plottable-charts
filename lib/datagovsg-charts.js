...
function getSingleColorScale(data) {
  return new Plottable.Scales.Color().range(data.map(function (d) {
    return DATAGOVSG_COLORS[0];
  }));
}
...
export { plugins, helpers, SimplePie, SimpleBar, GroupedBar, StackedBar, MultipleLine, DatagovsgSimplePie, DatagovsgSimpleBar, DatagovsgHorizontalBar, DatagovsgGroupedBar, DatagovsgStackedBar, DatagovsgLine };
